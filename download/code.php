...
<body>
    <div class="title">ShareSimple</div>
    <main>
        <form action="download.php" method="post">
            <input type="text" style="display: none;" name="file_id" value="<?= $file_id ?>" hidden />
            <fieldset>
                <legend>Please enter the passcode</legend>
                <div data-number-code-form="0">
                    <input type="number" autocomplete="off" min="0" max="9" name="number-code-0" data-number-code-input="0" autofocus="autofocus" required />
                    <input type="number" autocomplete="off" min="0" max="9" name="number-code-1" data-number-code-input="1" required />
                    <input type="number" autocomplete="off" min="0" max="9" name="number-code-2" data-number-code-input="2" required />
                    <input type="number" autocomplete="off" min="0" max="9" name="number-code-3" data-number-code-input="3" required />
                </div>
